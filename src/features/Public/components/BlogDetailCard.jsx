...
const BlogDetailCard = () => {
  ...
  return (
    <div className=" pt-[90px] xl:pt-40 xl:grid xl:grid-cols-3">
      <div className=" xl:col-span-2 xl:w-[739px]">
        <img
          ...
          className=" h-[553px] w-full object-cover"
          alt=""
        />
        <div className="flex flex-col gap-[60px] mt-[52px]">
          <div className="flex flex-col gap-8">
            <div>
              <h1 className="text-customGray-500 text-4xl xl:text-[40px] font-normal font-heading ">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="">
              ...
              <ul className="text-gray-500 text-base xl:text-xl font-medium pl-3 list-disc list-inside">
      ...
      <div className=" pt-[90px] xl:pt-0 xl:col-span-1 flex flex-col gap-8 ">
