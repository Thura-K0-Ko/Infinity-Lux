...
const EventParagraph = ({ subTitle, title, para1, para2 }) => {
  return (
    <div className=" xl:w-[1086px] xl:mx-auto">
      <h4 className="text-center text-customPurple-500 text-base xl:text-2xl font-medium mb-6">
        {subTitle}{" "}
      </h4>
      <h2 className="text-center text-customGray-500 font-heading text-[40px] xl:text-5xl font-normal mb-10 xl:mb-[60px]">
        {title}
      </h2>
