...
const MeetingAndEventCart = () => {
  return (
    <section>
      <Container>
        <div className=" mb-20 md:mb-0 md:py-[90px] xl:py-40">
          <div className="flex flex-col gap-10 xl:gap-[60px]">
            <div className=" flex flex-col gap-4 md:gap-6 items-center">
              ...
              <h1 className="text-customGray-500 text-[32px] md:text-[40px] xl:text-5xl font-heading font-normal">
                Meetings & Events
              </h1>
            </div>
            <div className=" grid grid-cols-1 md:grid-cols-2 gap-28 md:gap-5 ">
              <div className="col-span-1">
                <div className=" flex flex-col items-center relative">
                  ...
                  <Link
                    to={"/events/meeting"}
                    className=" w-[287px] md:w-auto   p-5 md:mx-8 xl:p-8 bg-customPurple-500 flex flex-col  md:gap-1.5 xl:gap-3  justify-center items-center   hover:shadow-lg transform duration-300 hover:bg-customPurple-800 focus:ring-4 focus:ring-customPurple-300 dark:bg-customPurple-600 dark:hover:bg-customPurple-700 focus:outline-none dark:focus:ring-customPurple-800"
                  >
                    <h3 className="text-center text-white text-xl xl:text-4xl font-heading font-normal ">
                      {" "}
                      Meeting Events
                    </h3>
                    <p className="text-gray-300 text-base xl:text-xl font-medium text-center">
              ...
              <div className="col-span-1">
                <div className=" flex flex-col items-center  relative">
                  ...
                  <Link
                    to={"events/wedding"}
                    className=" w-[287px] md:w-auto absolute bottom-0 translate-y-1/2 p-5 md:mx-8 xl:p-8 bg-customPurple-500 flex flex-col  md:gap-1.5 xl:gap-3  justify-center items-center   hover:shadow-lg transform duration-300 hover:bg-customPurple-800 focus:ring-4 focus:ring-customPurple-300 dark:bg-customPurple-600 dark:hover:bg-customPurple-700 focus:outline-none dark:focus:ring-customPurple-800"
                  >
                    <h3 className="text-center text-white text-xl xl:text-4xl font-heading font-normal ">
                      {" "}
                      Wedding Events
