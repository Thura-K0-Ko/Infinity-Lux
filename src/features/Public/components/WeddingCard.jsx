        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-10 md:gap-0">
            <div className=" col-span-1 xl:pl-20">
              <h3 className="text-customGray-500 font-heading text-[32px] xl:text-[40px] font-normal mb-9">
                Package Include
              </h3>
              <ul className="flex flex-col gap-6 xl:gap-8">
                <li className="flex items-center gap-4 xl:gap-5">
                  <img
                    ...
                    alt=""
                  />
                  <span className="text-black text-base xl:text-2xl font-medium">
                    Wedding Decoration
                  </span>
                </li>
      ...
      <div className=" pt-[50px] pb-[100px] md:py-[90px] xl:py-40">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            <div className=" h[408px] md:h-[446.45px] xl:h-[493px]">
              <img
