...
const VoucherCard = () => {
   return (
      <div className="shadow-xl">
         <h3 className="font-heading text-[32px] font-normal text-white bg-customPurple-500 p-5">Total</h3>
         <div className="p-8">
            <div className="flex flex-col gap-7">
               <div className="flex justify-between items-center text-customGray-500 text-xl">
