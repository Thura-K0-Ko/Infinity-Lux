...
const AboutInfinityLux = ({
  ...
  return (
    <section className="py-[80px] md:py-[90px] xl:py-40">
      <Container>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 xl:gap-5">
          <div className={className}>
            <div className=" flex flex-col gap-4 md:gap-8">
              ...
              <div className=" flex flex-col gap-6 md:gap-11 items-start">
                <h1 className="font-heading text-customGray-500 text-[32px] md:text-[40px] xl:text-5xl tracking-tight font-normal dark:text-neutral-900 ">
                  {title1}
                  <br /> {title2}
                </h1>
          ...
          <div className=" col-span-1 flex flex-col md:flex-row xl:justify-end gap-5 md:h-[580px] xl:h-auto">
