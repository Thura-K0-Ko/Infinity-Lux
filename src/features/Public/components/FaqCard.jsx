...
const FaqCard = () => {
  ...
  return (
    <>
      <div className="w-full md:w-[768px] xl:w-[1086px] mx-auto flex flex-col gap-9">
        {/* -----------------------GeneralFaq---------------------------- */}
        <GeneralFaq />
        ...
        <div>
          ...
          <div className="mt-4 md:mt-7">
            {reservationAndPaymentFaqs.map((faq) => (
              <div key={faq.id} className="py-4 md:py-6 ">
                <div
                  className="flex justify-between items-center cursor-pointer "
                  onClick={() => toggleReservationAndPaymentFaq(faq.id)}
                >
                  <h3 className="text-customGray-500 text-base md:text-2xl font-normal font-heading py-2 ">
                    {faq.question}
                  </h3>
                  <HiChevronDown
