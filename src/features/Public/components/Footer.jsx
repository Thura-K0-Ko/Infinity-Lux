              ...
              <div className="flex flex-col gap-5">
                ...
                <div className=" flex flex-col gap-3 text-gray-300 text-xl font-light ">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/google-play.svg.svg"
                        className=" h-10"
                        alt=""
                      />
                    </Link>
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/app-store.svg.svg"
                        className=" h-10"
                        alt=""
                      />
                    </Link>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className=" flex flex-col gap-3 text-gray-300 text-xl font-light ">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/ri_facebook-fill.png"
                        className=" h-6 "
                        alt=""
                      />
                    </Link>
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/devicon_twitter.png"
                        className=" h-6"
                        alt=""
                      />
                    </Link>
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/mdi_instagram.png"
                        className=" h-6"
                        alt=""
                      />
                    </Link>
                    ...
                    >
                      <img
                        src="/src/assets/Infinity Lux image Assets/Footer Logo/dashicons_linkedin.svg"
                        className=" h-6"
                        alt=""
                      />
                    </Link>
