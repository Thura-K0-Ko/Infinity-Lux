   ...
   return (
      <div className="col-span-2 flex flex-col gap-[60px]">
         ...
         <div className="flex flex-col gap-8">
            <div className="flex justify-between text-title font-heading font-normal">
         ...
         <div>
            ...
            <p className="text-gray-500 text-xl/8 font-medium">
               Children of all ages are welcome at our hotel. Complimentary
               stays are available for children 0-5 years using existing
               bedding. For added comfort, extra beds or cribs can be provided
               upon request, subject to availability and additional charges.
               Please inform us in advance to ensure the perfect setup for your
               family.
            </p>
         </div>
         <div>
