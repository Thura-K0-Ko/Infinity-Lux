...
const NewYear = () => {
  return (
    <div className="py-[80px] md:py-[90px] xl:py-40">
      <div className="relative h-[754px] md:h-[423.62px] xl:h-[768px] w-full overflow-hidden ">
        {/* Background Image */}
        <div
        ...
        <div className="relative h-full bg-black/30 flex flex-col items-center justify-center  ">
          <Container>
            <div className=" grid grid-cols-1 md:grid-cols-2 gap-24 md:gap-20 xl:gap-40 items-center">
              <div className=" col-span-1">
                <div className=" flex flex-col gap-4 md:gap-[13.24px] xl:gap-6 items-start justify-center">
                  {/* Special Offer Tag */}
                  ...
                  {/* Title */}
                  <div className=" flex flex-col gap-[19.86px] xl:gap-9 items-start">
              ...
              <div className="col-span-1 flex justify-center">
                <div className=" bg-customPurple-500 rounded-full size-[192px] xl:size-[340px] flex flex-col items-center justify-center md:gap-[11.3px] xl:gap-5">
                  <span className="text-white text-[11.03px] xl:text-xl font-medium">
                    Up To
                  </span>
                  <span className="text-white text-[52.95px] xl:text-8xl font-medium">
                    35%
                  </span>
                  <span className="text-white text-[11.03px] xl:text-xl font-medium">
                    On Selected Rooms
