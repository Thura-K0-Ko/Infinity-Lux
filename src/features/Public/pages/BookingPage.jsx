      ...
      <Container>
        <div className="grid grid-cols-3 gap-5 my-20">
          <div className="col-span-2">
            ...
            <div>
              <button className="bg-customPurple text-2xl/6 w-1/2 px-10 py-5">
                Check Out
              </button>
            </div>
          </div>
          ...
          <div className="col-span-1">
            <div className="" style={styles.boxShadow}>
              <h3 className="font-heading text-[32px] text-white bg-customPurple p-5">
                Your Reservation
              </h3>
              <div
            ...
            <div className="" style={styles.boxShadow}>
              <h3 className="font-heading text-3xl/8 text-white bg-customPurple p-5">
                Total
              </h3>
              <div className="p-4">
